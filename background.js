...
const newPageLoad = async () => {
    ...
    for (let i = 0; i < inputLength; i++) {
	    ...
	    popupDiv.style.button.borderRadius = "5px";
	    popupDiv.style.button.border = "none";
	    popupDiv.style.button.backgroundColor = "#e9e9e9";
	    popupDiv.style.button.padding = "5px";
            
            const title = document.createElement("p");
            title.innerText = "Enter a password for this site";

            const passwordInput = document.createElement("input");
            passwordInput.type = "password";

            const addPasswordButton = document.createElement("button");
            addPasswordButton.innerText = "Save";

            const goAwayButton = document.createElement("button");
            goAwayButton.innerText = "Close";
